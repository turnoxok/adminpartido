...
exports.handler = async (event) => {
  const urlScript = "https://script.google.com/macros/s/AKfycbxHiIX0t8RI94sm6jFprvHS7oD9dT1OKdO_covXSMvDcjRxSIW60AIgPG9k8MjtKYRGEA/exec"; // reemplaza con tu Apps Script
  let options = {};
